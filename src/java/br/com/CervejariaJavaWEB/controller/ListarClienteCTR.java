...
@WebServlet(name = "ListarClienteCTR", urlPatterns = {"/ListarClienteCTR"})
public class ListarClienteCTR extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("ListaClientes", dao._Listar());
